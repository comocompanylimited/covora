...
// Maps Covora nav slugs → exact short_description labels used on imported products
const SLUG_TO_CJ_CATEGORIES: Record<string, string[]> = {
  ...
  bottoms:      ["Bottoms"],
  denim:        ["Denim"],
  swimwear:     ["Dresses", "Tops & Blouses"],       // no swimwear leaf on CJ
  activewear:   ["Bottoms", "Tops & Blouses"],       // no activewear leaf on CJ
  lingerie:     ["Tops & Blouses"],                  // no lingerie leaf on CJ
  clothing:     ["Dresses", "Tops & Blouses", "Knitwear", "Co-ords", "Outerwear", "Bottoms", "Denim", "Loungewear"],
  heels:        ["Heels"],
  flats:        ["Flats"],
  boots:        ["Boots"],
  sneakers:     ["Sneakers"],
  sandals:      ["Sandals"],
  mules:        ["Mules"],
  "shoes-bags": ["Heels", "Flats", "Boots", "Sneakers", "Sandals", "Mules", "Tote Bags", "Crossbody Bags", "Clutches", "Shoulder Bags"],
  totes:        ["Tote Bags"],
  crossbody:    ["Crossbody Bags"],
  clutches:     ["Clutches"],
  "mini-bags":  ["Clutches"],
  bags:         ["Tote Bags", "Crossbody Bags", "Clutches", "Shoulder Bags"],
  jewellery:    ["Jewellery"],
  jewelry:      ["Jewellery"],
  scarves:      ["Scarves"],
