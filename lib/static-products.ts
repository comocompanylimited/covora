// Static product catalogue — no imports to avoid circular dependency.

export const STATIC_PRODUCTS = [
  { id: "1",  slug: "silk-midi-dress",    name: "The Silk Midi Dress",     price: "£485",  category: "Dresses",      categorySlug: "dresses",      badge: "New"  as const, bg: "#F0EDE8" },
  ...
  { id: "4",  slug: "leather-tote",       name: "Leather Tote",            price: "£680",  category: "Bags",         categorySlug: "bags",         badge: "Exclusive" as const, bg: "#EAE0D5" },
  { id: "5",  slug: "tailored-blazer",    name: "Tailored Blazer",         price: "£540",  category: "Outerwear",    categorySlug: "outerwear",    bg: "#E5E2DD" },
  { id: "6",  slug: "slip-dress",         name: "The Slip Dress",          price: "£395",  category: "Dresses",      categorySlug: "dresses",      badge: "New"  as const, bg: "#F2EDE8" },
  { id: "7",  slug: "heeled-mules",       name: "Suede Heeled Mules",      price: "£420",  category: "Shoes",        categorySlug: "shoes",        bg: "#EBE6E0" },
  { id: "8",  slug: "linen-co-ord",       name: "Linen Co-ord Set",        price: "£360",  category: "Co-ords",      categorySlug: "co-ords",      badge: "New"  as const, bg: "#EDF0E8" },
  { id: "9",  slug: "silk-shirt",         name: "Silk Button Shirt",       price: "£265",  category: "Tops",         categorySlug: "tops",         bg: "#EDE9E3" },
  { id: "10", slug: "flare-trousers",     name: "Flare Leg Trousers",      price: "£310",  category: "Bottoms",      categorySlug: "bottoms",      badge: "Sale" as const, originalPrice: "£390", bg: "#E8E4DF" },
  ...
  { id: "13", slug: "evening-gown",       name: "The Evening Gown",        price: "£1200", category: "Occasion Wear",categorySlug: "occasion-wear",badge: "New"  as const, bg: "#1a1214" },
  ...
  { id: "17", slug: "knit-mini-dress",    name: "Knit Mini Dress",         price: "£445",  category: "Dresses",      categorySlug: "dresses",      badge: "New"  as const, bg: "#F0EDE8" },
  { id: "18", slug: "satin-cami",         name: "Satin Cami Top",          price: "£195",  category: "Tops",         categorySlug: "tops",         bg: "#EDE9E3" },
  { id: "19", slug: "chain-handle-bag",   name: "Chain Handle Bag",        price: "£595",  category: "Bags",         categorySlug: "bags",         badge: "Exclusive" as const, bg: "#EAE0D5" },
  { id: "20", slug: "wide-brim-hat",      name: "Wide Brim Fedora",        price: "£155",  category: "Accessories",  categorySlug: "accessories",  bg: "#F2EDE8" },
] as const satisfies {
  id: string; slug: string; name: string; price: string;
