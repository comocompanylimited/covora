...
// Mens-only Client Component — isolates hover handlers from the Server Component
// parent (app/(store)/mens/page.tsx).

const PILLARS = [
  {
    number: "01",
    title: "Tailoring",
    body: "Sharp construction for every occasion — from boardroom precision to weekend ease.",
    href: "/mens/category/suits",
  },
  {
    number: "02",
    title: "Essentials",
    body: "Foundational wardrobe pieces executed in the finest available materials.",
    href: "/mens/category/tops",
  },
  {
    number: "03",
    title: "Outerwear",
    body: "Statement coats and jackets that carry the season with authority.",
    href: "/mens/category/jackets",
  },
]

export default function MensEditorialSection() {
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        ...
        >
          ...
          >
            The Modern{" "}
            <span style={{ fontStyle: "italic", color: "#3A3530" }}>Gentleman</span>
          </h2>
          ...
          >
            Refined silhouettes and considered fabrics for the man who dresses
