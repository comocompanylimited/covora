...
import MensProductCard from "@/components/mens/MensProductCard";
...
export const metadata: Metadata = {
  title: "Mens — Covora",
  description:
    "Discover the Covora Mens collection. Premium fashion crafted for the modern man.",
};

export default async function MensPage() {
  const products = await fetchMensProducts();
      ...
      <section className="relative flex items-center justify-center overflow-hidden" style={{ height: "82vh" }}>
        ...
        <div className="relative z-10 text-center px-6 select-none flex flex-col items-center" style={{ marginTop: "6vh" }}>
          ...
          >
            Covora
            <br />
            <span style={{ fontStyle: "italic", opacity: 0.9 }}>Mens</span>
          </h1>
